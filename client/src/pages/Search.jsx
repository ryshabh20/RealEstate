...
export default function Search() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7  border-b-2 md:border-r-2 border-light-gray  md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <button className="bg-blue text-white p-3 rounded-lg uppercase hover:opacity-95">
            Search
          </button>
        </form>
      </div>
