        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 font-semibold text-green-700 border bg-white border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80"
            >
              Upload
            </button>
          </div>
          <p className="text-red">{imageUploadError && imageUploadError}</p>
            ...
            formData.imageUrls.map((url, index) => (
              <div key={url} className="flex justify-between p-3 items-center">
                ...
                <button
                  ...
                  className="p-3 text-red rounded-lg uppercase hover:opacity-75"
                >
                  Delete
                </button>
              </div>
            ))}
          <button className="p-3 bg-blue text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
            Create Listing
          </button>
        </div>
      </form>
